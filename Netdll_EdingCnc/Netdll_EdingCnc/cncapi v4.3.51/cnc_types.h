...
typedef enum CNC_GPIO_ID
{
    ...
    //General purpose IO
    CNC_GPIOID_OUT_1,          //Ext io card output
    CNC_GPIOID_OUT_2,          //Ext io card output
    CNC_GPIOID_OUT_3,          //Ext io card output
    CNC_GPIOID_OUT_4,          //Ext io card output
    CNC_GPIOID_OUT_5,          //Ext io card output
    CNC_GPIOID_OUT_6,          //Ext io card output
    CNC_GPIOID_OUT_7,          //Ext io card output
    CNC_GPIOID_OUT_8,          //Ext io card output
    CNC_GPIOID_OUT_9,          //Ext io card output
    CNC_GPIOID_OUT_10,         //Ext io card output

    CNC_GPIOID_OUT_11,           //Ext io card input
    CNC_GPIOID_OUT_12,           //Ext io card input
    CNC_GPIOID_OUT_13,           //Ext io card input
    CNC_GPIOID_OUT_14,           //Ext io card input
    CNC_GPIOID_OUT_15,           //Ext io card input
    CNC_GPIOID_OUT_16,           //Ext io card input
    CNC_GPIOID_OUT_17,           //Ext io card input
    CNC_GPIOID_OUT_18,           //Ext io card input
    CNC_GPIOID_OUT_19,           //Ext io card input
    CNC_GPIOID_OUT_20,          //Ext io card input

    CNC_GPIOID_OUT_21,           //Ext io card input
    CNC_GPIOID_OUT_22,           //Ext io card input
    CNC_GPIOID_OUT_23,           //Ext io card input
    CNC_GPIOID_OUT_24,           //Ext io card input

    CNC_GPIOID_ANOUT_1,       //Ext io card output
    CNC_GPIOID_ANOUT_2,       //Ext io card output
    CNC_GPIOID_ANOUT_3,       //Ext io card output
    CNC_GPIOID_ANOUT_4,       //Ext io card output

    CNC_GPIOID_IN_1,           //Ext io card input
    CNC_GPIOID_IN_2,           //Ext io card input
    CNC_GPIOID_IN_3,           //Ext io card input
    CNC_GPIOID_IN_4,           //Ext io card input
    CNC_GPIOID_IN_5,           //Ext io card input
    CNC_GPIOID_IN_6,           //Ext io card input
    CNC_GPIOID_IN_7,           //Ext io card input
    CNC_GPIOID_IN_8,           //Ext io card input
    CNC_GPIOID_IN_9,           //Ext io card input
    CNC_GPIOID_IN_10,          //Ext io card input

    CNC_GPIOID_ANIN_1,         //Ext io card analogue input
    CNC_GPIOID_ANIN_2,         //Ext io card analogue input
    CNC_GPIOID_ANIN_3,         //Ext io card analogue input
    CNC_GPIOID_ANIN_4,         //Ext io card analogue input

    CNC_GPIOID_RULE_TRIGGER_STATUS, //Ext io card trigger status, bit 0 .. 15

    CNC_GPIO_ID_WARNING_OUT, //These are outputs on the CPU5B OPT connector
    CNC_GPIO_ID_ESTOP_OUT, //Output for the GPIO
    CNC_GPIO_ID_SSTOP_OUT, //Inputs for the CPU

    CNC_GPIOID_LAST                //Serves as last
...
typedef struct _CNC_SPINDLE_CONFIG
{
    ...
    /* if this is set our direction and on-off port change into rightOnOff and leftOnOff port */
...
typedef struct _CNC_INTERPRETER_CONFIG
{
    ...
    int reverseG2G3;          /* also for turning */
...
typedef struct _CNC_BASIC_INTERPRETER_STATUS
{
    ...
    double lafBlendAccuracy;    //P..
    double lineTolerance;       //Q..
    double lafAngleFullSpeed;   //R..
    double lafAngleReducedSpeed;//S..
    double lafDeltaReducedSpeed;//D..
    double lafFilter;           //F..

    double parameters0to27[27+5]; //First 27 + 101-105, otherwise this becomes too much
...
typedef struct _CNC_CONTROLLER_STATUS
{
    ...
    int gpioRLY24Present[CNC_MAX_GPIOCARD_CARDS];
