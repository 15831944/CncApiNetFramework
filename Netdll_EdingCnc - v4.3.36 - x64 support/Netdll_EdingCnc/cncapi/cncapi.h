 ...
 */
  ...
  */
 CNC_RC EXP2DF __stdcall CncWaitSingleLine(CNC_KEEP_UI_ALIVE_FUNCTION pKeepAlive, void *pKeepAliveParameter);       
...
*/
 ...
 CNC_RC EXP2DF __stdcall CncSwitchOnSpindleAndWaitUntilOn(CNC_KEEP_UI_ALIVE_FUNCTION pFunc, void *pFuncParameter, bool CCW);
 CNC_RC EXP2DF __stdcall CncSwitchOffSpindleAndWaitUntilOff(CNC_KEEP_UI_ALIVE_FUNCTION pFunc, void *pFuncParameter);
 ...
 * In     : axis
 *          feed [mm/minute] from UI
 * Out    : -
 * Return : See CNC_RC values
 * Descr  : In paused state move axes back to Pause position
 *          Required before Resume when moved away while in PAUSED state
 */ 
 int EXP2DF __stdcall CncSyncPauseAxis(int axis, double feed, CNC_KEEP_UI_ALIVE_FUNCTION pFunc, void *pFuncParameter);
