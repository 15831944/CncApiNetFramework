...
namespace OosterhofDesign
{
	...
	public:
		...
		property int dualQueueEnabled
		{
			int get()
			{
				return ValuePointertype->dualQueueEnabled;
			}
			void set(int Value)
			{
				ValuePointertype->dualQueueEnabled = Value;
			}
		}
	...
	public:
		...
		property double dynLowZvalue
		{
			double get()
			{
				return ValuePointertype->dynLowZvalue;
			}
			void set(double Value)
			{
				ValuePointertype->dynLowZvalue = Value;
			}
		}
		property int dynLowZGuardON
		{
			int get()
			{
				return ValuePointertype->dynLowZGuardON;
			}
			void set(int Value)
			{
				ValuePointertype->dynLowZGuardON = Value;
			}
		}
	...
	public ref class CncKinStatus :public Managedstruct<_CNC_KIN_STATUS>//pointer add
	{
	private:
	...
	public:
		CncKinStatus(_CNC_KIN_STATUS  *_KIN_STATUS) :Managedstruct(_KIN_STATUS)
		{
			NewClass();
		}
		...
		property int m_lowZguardActive
		{
			int get()
			{
				return ValuePointertype->m_lowZguardActive;
			}

		}
		property double m_lowZposition
		{
			double get()
			{
				return ValuePointertype->m_lowZposition;
			}
	...
	{
	private:
		CncM3_M9_RunningStatus^ Temp_m3m9RunningStatus;
		CncM3_M9_Present_Status^ Temp_m3m9PresentStatus;
		void NewClass()
		{
			Temp_m3m9RunningStatus = gcnew CncM3_M9_RunningStatus(&ValuePointertype->m3m9RunningStatus);
			Temp_m3m9PresentStatus = gcnew CncM3_M9_Present_Status(&ValuePointertype->m3m9PresentStatus);
		}
	public:
		...
		property int aborted2ndQueueRun
		{
			int get()
			{
				return ValuePointertype->aborted2ndQueueRun;
			}
		...
		property double stockZAtworkOffset
		{
			double get()
			{
		...
		property CncM3_M9_RunningStatus^ m3m9RunningStatus
		{
			CncM3_M9_RunningStatus^ get()
			{
				Temp_m3m9RunningStatus->ValuePointertype = &ValuePointertype->m3m9RunningStatus;
				return Temp_m3m9RunningStatus;
			}
		}
		property CncM3_M9_Present_Status^ m3m9PresentStatus
		{
			CncM3_M9_Present_Status^ get()
			{
				Temp_m3m9PresentStatus->ValuePointertype = &ValuePointertype->m3m9PresentStatus;
				return Temp_m3m9PresentStatus;
			}
		}
	};
	...
	private:
		...
		CncOffsetAndPlane^ Temp_pauseOffset;
		void NewClass()
		{
			...
			Temp_pauseOffset = gcnew CncOffsetAndPlane(&ValuePointertype->pauseOffset);
		}
	public:
		...
		property int programmedPause
		{
			int get()
			{
				return ValuePointertype->programmedPause;
			}
		...
		property CncOffsetAndPlane^ pauseOffset
		{
			CncOffsetAndPlane^ get()
			{
				Temp_pauseOffset->ValuePointertype = &ValuePointertype->pauseOffset;
				return Temp_pauseOffset;
			}
		...
		property int pauseSpindleDirectionIOValue
		{
			int get()
			{
				return ValuePointertype->pauseSpindleDirectionIOValue;
			}

		}
		property double pauseSpindleSpeed
		{
			double get()
			{
				return ValuePointertype->pauseSpindleSpeed;
			}
