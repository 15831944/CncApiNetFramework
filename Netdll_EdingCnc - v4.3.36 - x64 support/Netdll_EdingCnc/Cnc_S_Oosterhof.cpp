...
namespace OosterhofDesign
{
	...
	public:
		...
		static Cnc_Rc WaitSingleLine(CncKeepUiAliveFunction^ KEEP_UI_ALIVE)//CNC_KEEP_UI_ALIVE_FUNCTION
		{
			return  (Cnc_Rc)CncWaitSingleLine(KEEP_UI_ALIVE->Functionpfunc, KEEP_UI_ALIVE->ParsFuctionPointerParameter());
		}
	...
	{
	public:
		static Cnc_Rc SwitchOnSpindleAndWaitUntilOn(CncKeepUiAliveFunction^ KEEP_UI_ALIVE, bool CCW)
		{
			
			return (Cnc_Rc)CncSwitchOnSpindleAndWaitUntilOn(KEEP_UI_ALIVE->Functionpfunc, KEEP_UI_ALIVE->ParsFuctionPointerParameter(), CCW);
		}
		...
		static int SyncPauseAxis(int axis, double feed, CncKeepUiAliveFunction^ KEEP_UI_ALIVE)
		{

			return CncSyncPauseAxis(axis, feed, KEEP_UI_ALIVE->Functionpfunc, KEEP_UI_ALIVE->ParsFuctionPointerParameter());
		}
	...
	private:
		...
		//double * Axis = new double[CNC_MAX_AXES];
	public:
		static Cnc_Rc StartJogContinuous(array<double>^ axes,double velocityFactor, int continuous)
		{
			...
			_LastCNC_RC = (Cnc_Rc)CncStartJog(Axis->ValuePointertype,velocityFactor,continuous);
			return _LastCNC_RC;
		}
