...
namespace OosterhofDesign
{
	...
	public:
		...
		property String^ par1Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par1Name);
			}
		}
		property String^ par2Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par2Name);
			}
		}
		property String^ par3Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par3Name);
			}
		}
		property String^ par4Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par4Name);
			}
		}
		property String^ par5Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par5Name);
			}
		}
		property String^ par6Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par6Name);
			}
		}
		property String^ par7Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par7Name);
			}
		}
		...
		property String^ par9Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par9Name);
			}
		}
		property String^ par10Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par10Name);
			}
		}
		property String^ par11Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par11Name);
			}
		}
		property String^ par12Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par12Name);
			}
		}
		property String^ par13Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par13Name);
			}
		}
		property String^ par14Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par14Name);
			}
		}
		property String^ par15Name//[CNC_MAX_NAME_LENGTH];
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_NAME_LENGTH, Value, ValuePointertype->par15Name);
			}
		}
	...
	{
	private:
		array<double>^ _dData = gcnew array<double>(sizeof(ValuePointertype->dData) / SizeOfdoublex32);
		array<int>^ _iData = gcnew array<int>(sizeof(ValuePointertype->iData) / SizeOfintx32);
		array<char>^ _cData = gcnew array<char>(sizeof(ValuePointertype->cData));
	public:
		...
		property array<double>^ dData
		{
			array<double>^ get()
			{
				for (int i = 0; i < _dData->Length; i++)
				{
					_dData[i] = ValuePointertype->dData[i];
				}
				return _dData;
			}
			void set(array<double>^ Value)
			{
				for (int i = 0; i < _dData->Length; i++)
				{
					...
					ValuePointertype->dData[i] = _dData[i];
				}
		...
		property array<int>^ iData
		{
			array<int>^get()
			{
				...
				{
					_iData[i] = ValuePointertype->iData[i];
				}
			...
			void set(array<int>^Value)
			{
				for (int i = 0; i < _iData->Length; i++)
				{
					...
					ValuePointertype->iData[i] = _iData[i];
				}
			}
		}
		property array<char>^ cData
		{
			array<char>^get()
			{
				...
				{
					_cData[i] = ValuePointertype->cData[i];
				}
			...
			void set(array<char> ^Value)
			{
				for (int i = 0; i < _cData->Length; i++)
				{
					...
					ValuePointertype->cData[i] = _cData[i];
				}
			}
		}
	};
	...
	{
	private:
		array<unsigned char>^ _actions = gcnew array<unsigned char>(sizeof(ValuePointertype->actions));
		array<unsigned char>^ _hardwareIONumber = gcnew array<unsigned char>(sizeof(ValuePointertype->hardwareIONumber));
	public:
		CncUioSelectorConfig(CNC_UIO_SELECTOR_CONFIG * _Temp_CNC_UIO_SELECTOR_CONFIG) :Managedstruct(_Temp_CNC_UIO_SELECTOR_CONFIG) {}
		CncUioSelectorConfig() :Managedstruct(nullptr) {}//added 5-11-2018 i.v.b = CopyUnmanagedPointer
		...
		property array<unsigned char>^ hardwareIONumber
		{
			...
			{
				for (int i = 0; i < _hardwareIONumber->Length; i++)
				{
					_hardwareIONumber[i] = ValuePointertype->hardwareIONumber[i];
				}
				return _hardwareIONumber;
			}
			void set(array<unsigned char>^ Value)
			{
				if (Value->Length == _hardwareIONumber->Length)
				{
					for (int i = 0; i < _hardwareIONumber->Length; i++)
					{
		...
		property array<unsigned char>^ actions
		{
			array<unsigned char>^ get()
			{
				...
				{
					_actions[i] = ValuePointertype->actions[i];
				}
				return _actions;
			}
			void set(array<unsigned char>^ Value)
			{
				if (Value->Length == _actions->Length)
				{
					for (int i = 0; i < _actions->Length; i++)
					{
	...
	{
	private:
		array<int>^ _reserved = gcnew array<int>(sizeof(ValuePointertype->reserved) / SizeOfintx32);
	public:
		CncSystemConfig(CNC_SYSTEM_CONFIG * CONFIG) :Managedstruct(CONFIG) {}//added 5-11-2018 i.v.b = CopyUnmanagedPointer
		CncSystemConfig() :Managedstruct(nullptr) {}//added 5-11-2018 i.v.b = CopyUnmanagedPointer
		...
		*/
		...
		property array<int>^ reserved
		{
			array<int>^ get()
			{
				...
				{
					_reserved[i] = ValuePointertype->reserved[i];
				}
				return _reserved;
			}
			void set(array<int>^ Value)
			{
				if (_reserved->Length == Value->Length)
				{
					for (int i = 0; i < _reserved->Length; i++)
					{
	...
	{
	private:
		array<int>^ _auxInputCheckSenseLevel = gcnew array<int>(sizeof(ValuePointertype->auxInputCheckSenseLevel) / SizeOfintx32);
	public:
		...
		property array<int>^ auxInputCheckSenseLevel
		{
			array<int>^ get()
			{
				for (int i = 0; i < _auxInputCheckSenseLevel->Length; i++)
				{
					_auxInputCheckSenseLevel[i] = ValuePointertype->auxInputCheckSenseLevel[i];
				}
			...
			void set(array<int>^ Value)
			{
				if (_auxInputCheckSenseLevel->Length == Value->Length)
				{
					for (int i = 0; i < _auxInputCheckSenseLevel->Length; i++)
					{
						ValuePointertype->auxInputCheckSenseLevel[i] = _auxInputCheckSenseLevel[i];
					}
				}
			}
		}
	...
	public:
		...
		property String^ probeTouchPointFileName
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_PATH, Value, ValuePointertype->probeTouchPointFileName);
			}
		}
	...
	public:
		...
		property String^ pitchCompensationFileName
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_PATH, Value, ValuePointertype->pitchCompensationFileName);
			}
		}
		...
		property String^ crossCompensationFileName
		{
			...
			void set(String^ Value)
			{
				StringConversie::SYSTEM_STRING_toMaxCharLength(CNC_MAX_PATH, Value, ValuePointertype->crossCompensationFileName);
			}
		}
	...
	{
	private:
		array<double>^ _reserved = nullptr;
		void NewClass()
		{
			_reserved = gcnew array<double>(sizeof(ValuePointertype->reserved) / SizeOfdoublex32);
		}
	public:
		...
		property array<double>^ reserved
		{
			...
			void set(array<double>^ value)
			{
				if (value->Length == _reserved->Length)
				{
					for (int i = 0; i < _reserved->Length; i++)
					{
						ValuePointertype->reserved[i] = value[i];
	...
	private://controllerFrequencyTimerValues
		array<int>^ _controllerFrequencyTimerValues = gcnew array<int>(sizeof(ValuePointertype->controllerFrequencyTimerValues) / SizeOfintx32);
		array<double>^ _controllerFrequencies = gcnew array<double>(sizeof(ValuePointertype->controllerFrequencies) / SizeOfdoublex32);
		array<String^>^ _comPortList = gcnew array<String^>(CNC_MAX_COMM_PORTS);
	public:
		CncControllerConfigStatus(CNC_CONTROLLER_CONFIG_STATUS * _CONTROLLER_CONFIG_STATUS) :Managedstruct(_CONTROLLER_CONFIG_STATUS) {}
		CncControllerConfigStatus() :Managedstruct(nullptr) {}//added 5-11-2018 i.v.b = CopyUnmanagedPointer
		...
		property array<String^>^ comPortList
		{
			array<String^>^ get()
			{
				...
				if (_comPortList->Length < Temp_ComportLength)
				{
					Temp_ComportLength = _comPortList->Length;
				}

				for (int i = 0; i < Temp_ComportLength; i++)
				{
					_comPortList[i] = StringConversie::SDT_STRING_toSYSTEM_STRING(ValuePointertype->comPortList[i]);
				}
		...
		property array<double>^ controllerFrequencies
		{
			array<double>^ get()
			{
				for (int i = 0; i < _controllerFrequencies->Length; i++)
				{
					_controllerFrequencies[i] = ValuePointertype->controllerFrequencies[i];
				}
		...
		property array<int>^ controllerFrequencyTimerValues
		{
			array<int>^ get()
			{
				for (int i = 0; i < _controllerFrequencyTimerValues->Length; i++)
				{
					_controllerFrequencyTimerValues[i] = ValuePointertype->controllerFrequencyTimerValues[i];
				}
	...
	public ref class CncM3_M9_RunningStatus :Managedstruct<CNC_M3_M9_RUNNING_STATUS>
	{
	public:
		CncM3_M9_RunningStatus(CNC_M3_M9_RUNNING_STATUS * _M3_M9_RUNNING_STATUS) :Managedstruct(_M3_M9_RUNNING_STATUS) {}
		CncM3_M9_RunningStatus() :Managedstruct(nullptr) {}
		bool CopyUnmanagedPointer(CncM3_M9_RunningStatus^ SOURCE)
		{
			return CopyPointerDataToClass(SOURCE->ValuePointertype, SOURCE->ArrayLength);
		}
		/* 1 if running by call from main
		 * 2 if running as sub only
		 * 3 if running as sub in 2nd queue mode
		 */
		property int runningSubM3
		{
			int get()
			{
				return  ValuePointertype->runningSubM3;
			}
		}
		property int runningSubM4
		{
			int get()
			{
				return  ValuePointertype->runningSubM4;
			}
		}
		property int runningSubM5
		{
			int get()
			{
				return  ValuePointertype->runningSubM5;
			}
		}
		property int runningSubM6
		{
			int get()
			{
				return  ValuePointertype->runningSubM6;
			}
		}
		property int runningSubM7
		{
			int get()
			{
				return  ValuePointertype->runningSubM7;
			}
		}
		property int runningSubM8
		{
			int get()
			{
				return  ValuePointertype->runningSubM8;
			}
		}
		property int runningSubM9
		{
			int get()
			{
				return  ValuePointertype->runningSubM9;
			}
		}

	};
	public ref class CncM3_M9_Present_Status :Managedstruct<CNC_M3_M9_PRESENT_STATUS>
	{
	public:
		CncM3_M9_Present_Status(CNC_M3_M9_PRESENT_STATUS * _M3_M9_PRESENT_STATUS) :Managedstruct(_M3_M9_PRESENT_STATUS) {}
		CncM3_M9_Present_Status() :Managedstruct(nullptr) {}
		bool CopyUnmanagedPointer(CncM3_M9_Present_Status^ SOURCE)
		{
			return CopyPointerDataToClass(SOURCE->ValuePointertype, SOURCE->ArrayLength);
		}
		/* subs present macro.cnc */
		property int subM3Present
		{
			int get()
			{
				return  ValuePointertype->subM3Present;
			}
		}
		property int subM4Present
		{
			int get()
			{
				return  ValuePointertype->subM4Present;
			}
		}
		property int subM5Present
		{
			int get()
			{
				return  ValuePointertype->subM5Present;
			}
		}
		property int subM6Present
		{
			int get()
			{
				return  ValuePointertype->subM6Present;
			}
		}
		property int subM7Present
		{
			int get()
			{
				return  ValuePointertype->subM7Present;
			}
		}
		property int subM8Present
		{
			int get()
			{
				return  ValuePointertype->subM8Present;
			}
		}
		property int subM9Present
		{
			int get()
			{
				return  ValuePointertype->subM9Present;
			}
		}
	};
	...
	{
	private:
		array<int>^ _vacuumSectionConfigured = nullptr;
		array<int>^ _vacuumSectionCrossed = nullptr;

		void NewClass()
		{
			_vacuumSectionConfigured = gcnew array<int>(CNC_MAX_VACUUMBED_SECTIONS);
			_vacuumSectionCrossed = gcnew array<int>(CNC_MAX_VACUUMBED_SECTIONS);
		}
	public:
		...
		property array<int>^ vacuumSectionConfigured//[CNC_MAX_VACUUMBED_SECTIONS];
		{
			array<int>^ get()
			{
				for (int i = 0; i < _vacuumSectionConfigured->Length; i++)
				{
					_vacuumSectionConfigured[i] = ValuePointertype->vacuumSectionConfigured[i];
				}
			...
			void set(array<int>^ Value)
			{
				if (Value->Length == _vacuumSectionConfigured->Length)
				{
					for (int i = 0; i < _vacuumSectionConfigured->Length; i++)
					{
		...
		property array<int>^ vacuumSectionCrossed//[CNC_MAX_VACUUMBED_SECTIONS];
		{
			array<int>^ get()
			{
				for (int i = 0; i < _vacuumSectionCrossed->Length; i++)
				{
					_vacuumSectionCrossed[i] = ValuePointertype->vacuumSectionCrossed[i];
				}
				return _vacuumSectionCrossed;
			}
			void set(array<int>^ Value)
			{
				if (Value->Length == _vacuumSectionCrossed->Length)
				{
					for (int i = 0; i < _vacuumSectionCrossed->Length; i++)
					{
